...
<html lang="en">
    ...
    <head>
        ...
        $num_of_subjects = mysqli_num_rows($result);
        
        // $result = $conn->query('SELECT * FROM dep'); 
        // $num_of_dep = mysqli_num_rows($result);

        $result = $conn->query("SELECT * FROM users WHERE Role !='Admin'");
        $num_of_staff = mysqli_num_rows($result);
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <div class="fluid-container">
                                                <h3 class="font-weight-medium text-right mb-0"><?php echo $num_of_dep; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-statistics">
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            <p class="mb-0 text-right">Total Staffs</p>
                                            <div class="fluid-container">
                                                <h3 class="font-weight-medium text-right mb-0"><?php echo $num_of_staff; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
