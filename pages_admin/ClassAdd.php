    ...
    <head>
        ...
        if(isset($_POST['insert'])){
            if (!$conn) {
                ...
                $stmt = $conn->prepare("SELECT * FROM dep WHERE depname=?");
                ...
                if($count==0){ // if classID does not exist	
                    ...
                    if($err){
                        $sql = "INSERT INTO dep(depname) VALUES ('$className');";
                        if (mysqli_query($conn, $sql)) {
                            //                        echo $bname." added to table successfully";
                            echo "<script> alert('".$className." Department Added Successfully!'); location.href='ClassView.php'; </script>";
                        } 
                        else {
                    ...
                    $errMSG = "Department already exists!";
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="page-header clearfix">
                                                <h2 style="float:left">Add Department</h2>				
                                            </div>
